            ...
            <v-col cols="6" class="pa-0">
              ...
              <v-card flat width="200" class="pa-0 border-input">
                <Poptip trigger="focus">
                  ...
                  />
                  <template #content>
                    <div class="custom-font">{{ formatNumber(form.price) }}</div>
                  </template>
                </Poptip>
              </v-card>
            </v-card-actions>
            ...
            <v-col cols="6" class="pa-0">
              ...
              <v-card flat width="200" class="pa-0 border-input">
                <Poptip trigger="focus">
                  ...
                  />
                  <template #content>
                    <div class="custom-font">{{ formatNumber(form.reduced) }}</div>
                  </template>
                </Poptip>
              </v-card>
            </v-card-actions>
              ...
              &nbsp;
                <v-card flat width="200" class="pa-0 border-input">
                  <Select
                    ...
                    :placeholder="form.resolution ? form.resolution : 'ໝອດໝູ່ວີດີໂອ'"
                    class="custom-font"
                    style="width: 200px"
                  >
                    <Option
